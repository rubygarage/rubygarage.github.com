...
## Bdd cycle
![](/assets/bdd/bdd-cycle-around-tdd-cycles.png){: .bdd-cycle}
...
## Meet the Capybara
![](/assets/bdd/capybara.jpg){: .capybara width="500"}
...
NameError:
undefined local variable or method 'register_path' for #
```
...
undefined method 'users_path' for #:0x007f91f5a36e78>
```
config/routes.rb
```ruby
Bookstore::Application.routes.draw do
...
$ rspec spec/controllers/users_controller_spec.rb
NameError:
undefined local variable or method 'root_url' for #
```
